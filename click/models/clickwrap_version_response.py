...
class ClickwrapVersionResponse(object):
    ...
    def __init__(self, account_id=None, clickwrap_id=None, clickwrap_name=None, clickwrap_version_id=None, created_time=None, display_settings=None, documents=None, last_modified=None, last_modified_by=None, owner_user_id=None, require_reacceptance=None, scheduled_date=None, scheduled_reacceptance=None, status=None, version_id=None, version_number=None):  # noqa: E501
