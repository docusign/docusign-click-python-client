...
class ClickwrapVersionDeleteResponse(object):
    ...
    def __init__(self, clickwrap_version_id=None, created_time=None, deletion_message=None, deletion_success=None, last_modified=None, last_modified_by=None, owner_user_id=None, require_reacceptance=None, scheduled_date=None, scheduled_reacceptance=None, status=None, version_id=None, version_number=None):  # noqa: E501
